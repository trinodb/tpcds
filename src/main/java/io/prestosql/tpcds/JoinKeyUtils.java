...
import io.prestosql.tpcds.distribution.CalendarDistribution;
...
import static io.prestosql.tpcds.PseudoTableScalingInfos.CONCURRENT_WEB_SITES;
...
import static io.prestosql.tpcds.distribution.CalendarDistribution.Weights.SALES;
import static io.prestosql.tpcds.distribution.CalendarDistribution.Weights.SALES_LEAP_YEAR;
import static io.prestosql.tpcds.distribution.CalendarDistribution.Weights.UNIFORM_LEAP_YEAR;
import static io.prestosql.tpcds.distribution.CalendarDistribution.pickRandomDayOfYear;
import static io.prestosql.tpcds.distribution.CatalogPageDistributions.pickRandomCatalogPageType;
import static io.prestosql.tpcds.distribution.HoursDistribution.Weights.CATALOG_AND_WEB;
import static io.prestosql.tpcds.distribution.HoursDistribution.Weights.STORE;
import static io.prestosql.tpcds.distribution.HoursDistribution.Weights.UNIFORM;
import static io.prestosql.tpcds.distribution.HoursDistribution.pickRandomHour;
import static io.prestosql.tpcds.generator.WebPageGeneratorColumn.WP_CREATION_DATE_SK;
...
import static io.prestosql.tpcds.row.generator.CatalogPageRowGenerator.CATALOGS_PER_YEAR;
import static io.prestosql.tpcds.row.generator.CatalogSalesRowGenerator.CS_MAX_SHIP_DELAY;
import static io.prestosql.tpcds.row.generator.CatalogSalesRowGenerator.CS_MIN_SHIP_DELAY;
import static io.prestosql.tpcds.type.Date.DATE_MAXIMUM;
import static io.prestosql.tpcds.type.Date.DATE_MINIMUM;
import static io.prestosql.tpcds.type.Date.JULIAN_DATA_START_DATE;
import static io.prestosql.tpcds.type.Date.JULIAN_DATE_MAXIMUM;
...
import static io.prestosql.tpcds.type.Date.isLeapYear;
