...
import io.prestosql.tpcds.row.DateDimRow;
...
import static io.prestosql.tpcds.distribution.CalendarDistribution.getIsHolidayFlagAtIndex;
import static io.prestosql.tpcds.distribution.CalendarDistribution.getQuarterAtIndex;
import static io.prestosql.tpcds.generator.DateDimGeneratorColumn.D_NULLS;
import static io.prestosql.tpcds.type.Date.CURRENT_QUARTER;
import static io.prestosql.tpcds.type.Date.CURRENT_WEEK;
import static io.prestosql.tpcds.type.Date.TODAYS_DATE;
import static io.prestosql.tpcds.type.Date.WEEKDAY_NAMES;
import static io.prestosql.tpcds.type.Date.computeDayOfWeek;
import static io.prestosql.tpcds.type.Date.computeFirstDateOfMonth;
import static io.prestosql.tpcds.type.Date.computeLastDateOfMonth;
import static io.prestosql.tpcds.type.Date.computeSameDayLastQuarter;
import static io.prestosql.tpcds.type.Date.computeSameDayLastYear;
import static io.prestosql.tpcds.type.Date.fromJulianDays;
import static io.prestosql.tpcds.type.Date.getDayIndex;
