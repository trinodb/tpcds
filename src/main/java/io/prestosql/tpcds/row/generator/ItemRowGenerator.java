...
import io.prestosql.tpcds.SlowlyChangingDimensionUtils.SlowlyChangingDimensionKey;
import io.prestosql.tpcds.distribution.CategoriesDistribution;
import io.prestosql.tpcds.distribution.CategoryClassDistributions.CategoryClass;
import io.prestosql.tpcds.distribution.ItemsDistributions;
import io.prestosql.tpcds.row.ItemRow;
...
import static io.prestosql.tpcds.SlowlyChangingDimensionUtils.computeScdKey;
...
import static io.prestosql.tpcds.distribution.CategoriesDistribution.getCategoryAtIndex;
import static io.prestosql.tpcds.distribution.CategoriesDistribution.getHasSizeAtIndex;
import static io.prestosql.tpcds.distribution.CategoryClassDistributions.pickRandomCategoryClass;
import static io.prestosql.tpcds.distribution.EnglishDistributions.SYLLABLES_DISTRIBUTION;
import static io.prestosql.tpcds.distribution.ItemCurrentPriceDistribution.pickRandomCurrentPriceRange;
import static io.prestosql.tpcds.distribution.ItemsDistributions.BRAND_SYLLABLES_DISTRIBUTION;
import static io.prestosql.tpcds.distribution.ItemsDistributions.ColorsWeights.SKEWED;
import static io.prestosql.tpcds.distribution.ItemsDistributions.IdWeights.UNIFIED;
import static io.prestosql.tpcds.distribution.ItemsDistributions.SizeWeights.NO_SIZE;
import static io.prestosql.tpcds.distribution.ItemsDistributions.SizeWeights.SIZED;
import static io.prestosql.tpcds.distribution.ItemsDistributions.pickRandomColor;
import static io.prestosql.tpcds.distribution.ItemsDistributions.pickRandomManufactIdRange;
import static io.prestosql.tpcds.distribution.ItemsDistributions.pickRandomSize;
import static io.prestosql.tpcds.distribution.ItemsDistributions.pickRandomUnit;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_CATEGORY;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_CLASS;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_COLOR;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_CURRENT_PRICE;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_FORMULATION;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_ITEM_DESC;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_MANAGER_ID;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_MANUFACT_ID;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_NULLS;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_PROMO_SK;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_SCD;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_SIZE;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_UNITS;
import static io.prestosql.tpcds.generator.ItemGeneratorColumn.I_WHOLESALE_COST;
import static io.prestosql.tpcds.random.RandomValueGenerator.DIGITS;
import static io.prestosql.tpcds.random.RandomValueGenerator.generateRandomCharset;
import static io.prestosql.tpcds.random.RandomValueGenerator.generateRandomText;
import static io.prestosql.tpcds.random.RandomValueGenerator.generateUniformRandomDecimal;
import static io.prestosql.tpcds.random.RandomValueGenerator.generateUniformRandomInt;
import static io.prestosql.tpcds.random.RandomValueGenerator.generateUniformRandomKey;
import static io.prestosql.tpcds.random.RandomValueGenerator.generateWord;
import static io.prestosql.tpcds.type.Decimal.multiply;
