...
import io.prestosql.tpcds.row.HouseholdDemographicsRow;

import static io.prestosql.tpcds.Nulls.createNullBitMap;
import static io.prestosql.tpcds.Table.HOUSEHOLD_DEMOGRAPHICS;
import static io.prestosql.tpcds.distribution.DemographicsDistributions.BUY_POTENTIAL_DISTRIBUTION;
import static io.prestosql.tpcds.distribution.DemographicsDistributions.DEP_COUNT_DISTRIBUTION;
import static io.prestosql.tpcds.distribution.DemographicsDistributions.INCOME_BAND_DISTRIBUTION;
import static io.prestosql.tpcds.distribution.DemographicsDistributions.getBuyPotentialForIndexModSize;
import static io.prestosql.tpcds.distribution.DemographicsDistributions.getDepCountForIndexModSize;
import static io.prestosql.tpcds.distribution.DemographicsDistributions.getVehicleCountForIndexModSize;
import static io.prestosql.tpcds.generator.HouseholdDemographicsGeneratorColumn.HD_NULLS;
