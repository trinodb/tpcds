...
import io.prestosql.tpcds.distribution.FipsCountyDistribution;
import io.prestosql.tpcds.random.RandomNumberStream;

import static com.google.common.base.Preconditions.checkArgument;
import static io.prestosql.tpcds.PseudoTableScalingInfos.ACTIVE_CITIES;
import static io.prestosql.tpcds.PseudoTableScalingInfos.ACTIVE_COUNTIES;
import static io.prestosql.tpcds.distribution.AddressDistributions.CitiesWeights.UNIFIED_STEP_FUNCTION;
import static io.prestosql.tpcds.distribution.AddressDistributions.StreetNamesWeights.DEFAULT;
import static io.prestosql.tpcds.distribution.AddressDistributions.StreetNamesWeights.HALF_EMPTY;
import static io.prestosql.tpcds.distribution.AddressDistributions.getCityAtIndex;
import static io.prestosql.tpcds.distribution.AddressDistributions.pickRandomCity;
import static io.prestosql.tpcds.distribution.AddressDistributions.pickRandomStreetName;
import static io.prestosql.tpcds.distribution.AddressDistributions.pickRandomStreetType;
import static io.prestosql.tpcds.distribution.FipsCountyDistribution.FipsWeights.UNIFORM;
import static io.prestosql.tpcds.distribution.FipsCountyDistribution.getCountyAtIndex;
import static io.prestosql.tpcds.distribution.FipsCountyDistribution.getGmtOffsetAtIndex;
import static io.prestosql.tpcds.distribution.FipsCountyDistribution.getStateAbbreviationAtIndex;
import static io.prestosql.tpcds.distribution.FipsCountyDistribution.getZipPrefixAtIndex;
