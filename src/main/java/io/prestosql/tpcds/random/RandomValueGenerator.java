...
package io.prestosql.tpcds.random;

import io.prestosql.tpcds.distribution.CalendarDistribution;
import io.prestosql.tpcds.distribution.StringValuesDistribution;
import io.prestosql.tpcds.type.Date;
import io.prestosql.tpcds.type.Decimal;

import static io.prestosql.tpcds.distribution.CalendarDistribution.getWeightForDayNumber;
import static io.prestosql.tpcds.distribution.EnglishDistributions.pickRandomAdjective;
import static io.prestosql.tpcds.distribution.EnglishDistributions.pickRandomAdverb;
import static io.prestosql.tpcds.distribution.EnglishDistributions.pickRandomArticle;
import static io.prestosql.tpcds.distribution.EnglishDistributions.pickRandomAuxiliary;
import static io.prestosql.tpcds.distribution.EnglishDistributions.pickRandomNoun;
import static io.prestosql.tpcds.distribution.EnglishDistributions.pickRandomPreposition;
import static io.prestosql.tpcds.distribution.EnglishDistributions.pickRandomSentence;
import static io.prestosql.tpcds.distribution.EnglishDistributions.pickRandomTerminator;
import static io.prestosql.tpcds.distribution.EnglishDistributions.pickRandomVerb;
import static io.prestosql.tpcds.distribution.TopDomainsDistribution.pickRandomTopDomain;
import static io.prestosql.tpcds.type.Date.fromJulianDays;
import static io.prestosql.tpcds.type.Date.getDaysInYear;
